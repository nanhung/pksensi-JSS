...
```{r, eval=T, fig.cap = 'Figure 1. Simulation results of one-compartment PBTK model.'}
plot(y)
```
...
```{r, eval=T, fig.height=8, fig.width=8, fig.cap = 'Figure 4. '}
