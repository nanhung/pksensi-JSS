...
On the other side, if the user only have the \proglang{C} version of the model code (\code{pbtk1cpt.c}), it can be compiled and loaded as:
...
The \code{Outputs} is a "character" that specify the estimated model output of concentration in rest body.
